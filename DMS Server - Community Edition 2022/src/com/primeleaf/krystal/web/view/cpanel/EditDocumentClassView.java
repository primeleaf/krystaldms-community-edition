...
public class EditDocumentClassView extends WebView {
	...
	private void printNewDocumentClassForm() throws Exception{
		...
		try {
			...
			out.println("<div class=\"col-sm-2\"><input type=\"text\" id=\"txtExpiryPeriod\" name=\"txtExpiryPeriod\"  class=\"required form-control digits range\" min=\"0\" max=\"9999\" title=\"Please enter Default Expiry Period\" value=\""+ documentClass.getExpiryPeriod() + "\" maxlength=\"4\"></div>" );
			...
			out.println("<input class=\"btn-check\" type=\"radio\" id=\"radActive1\" name=\"radActive\""); if(documentClass.isVisible()) {out.print("checked ");} out.print(" value=\"Y\">");
			out.println("<label for=\"radActive1\" class=\"btn btn-outline-dark\" for=\"radActive1\">Yes</label>");
			out.println("<input class=\"btn-check\" type=\"radio\" id=\"radActive2\" name=\"radActive\""); if(!documentClass.isVisible()) {out.print("checked ");} out.print(" value=\"N\">");
			...
			out.println("<div class=\"btn-group col-sm-2\" data-bs-toggle=\"buttons\">");
			out.println("<input class=\"btn-check\" type=\"radio\" id=\"radRevisionControl1\" name=\"radRevisionControl\""); if(documentClass.isRevisionControlEnabled()) {out.print("checked ");} out.print("value=\"Y\">");
			out.println("<label for=\"radRevisionControl1\" class=\"btn btn-outline-dark\">Yes</label>");
			out.println("<input class=\"btn-check\" type=\"radio\" id=\"radRevisionControl2\" name=\"radRevisionControl\""); if(!documentClass.isRevisionControlEnabled()) {out.print("checked ");} out.print("value=\"N\">");
			out.println("<label for=\"radRevisionControl2\" class=\"btn btn-outline-dark\">No</label>");
			out.println("</div>");
			out.println("</div>");
